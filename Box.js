class Box {
    constructor(x, y, w, h) {
        ...
        //creating width and height properties so as to make them accessible in display function
        //x and y not needed here as there already are properties for e and y in physics engine
        this.width = w;
        this.height = h;
